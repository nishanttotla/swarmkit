...
type ServiceSpec_Hook struct {
	Hook *HookService `protobuf:"bytes,5,opt,name=hook,oneof"`
}
type ServiceSpec_Stateful struct {
	Stateful *StatefulService `protobuf:"bytes,10,opt,name=stateful,oneof"`
}

func (*ServiceSpec_Replicated) isServiceSpec_Mode() {}
func (*ServiceSpec_Global) isServiceSpec_Mode()     {}
func (*ServiceSpec_Hook) isServiceSpec_Mode()       {}
func (*ServiceSpec_Stateful) isServiceSpec_Mode()   {}
...
func (m *ServiceSpec) GetHook() *HookService {
	if x, ok := m.GetMode().(*ServiceSpec_Hook); ok {
		return x.Hook
	}
	return nil
}

func (m *ServiceSpec) GetStateful() *StatefulService {
	if x, ok := m.GetMode().(*ServiceSpec_Stateful); ok {
		return x.Stateful
	}
	return nil
}
...
func (*ServiceSpec) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ServiceSpec_OneofMarshaler, _ServiceSpec_OneofUnmarshaler, _ServiceSpec_OneofSizer, []interface{}{
		...
		(*ServiceSpec_Hook)(nil),
		(*ServiceSpec_Stateful)(nil),
	}
}
...
func _ServiceSpec_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ServiceSpec_Hook:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Hook); err != nil {
			return err
		}
	case *ServiceSpec_Stateful:
		_ = b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Stateful); err != nil {
			return err
		}
	case nil:
	default:
...
func _ServiceSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 5: // mode.hook
		...
		msg := new(HookService)
		err := b.DecodeMessage(msg)
		m.Mode = &ServiceSpec_Hook{msg}
		return true, err
	case 10: // mode.stateful
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(StatefulService)
		err := b.DecodeMessage(msg)
		m.Mode = &ServiceSpec_Stateful{msg}
		return true, err
	default:
		return false, nil
	}
...
// HookService represents services that don't actually run.
type HookService struct {
}

func (m *HookService) Reset()                    { *m = HookService{} }
func (*HookService) ProtoMessage()               {}
func (*HookService) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{4} }

// StatefulService represents stateful services.
type StatefulService struct {
	Replicas        uint64 `protobuf:"varint,1,opt,name=replicas,proto3" json:"replicas,omitempty"`
	InitHookID      string `protobuf:"bytes,2,opt,name=init_hook_id,json=initHookId,proto3" json:"init_hook_id,omitempty"`
	PreScaleHookID  string `protobuf:"bytes,3,opt,name=pre_scale_hook_id,json=preScaleHookId,proto3" json:"pre_scale_hook_id,omitempty"`
	PostScaleHookID string `protobuf:"bytes,4,opt,name=post_scale_hook_id,json=postScaleHookId,proto3" json:"post_scale_hook_id,omitempty"`
}

func (m *StatefulService) Reset()                    { *m = StatefulService{} }
func (*StatefulService) ProtoMessage()               {}
func (*StatefulService) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{5} }
...
func init() {
	...
	proto.RegisterType((*HookService)(nil), "docker.swarmkit.v1.HookService")
	proto.RegisterType((*StatefulService)(nil), "docker.swarmkit.v1.StatefulService")
	...
	*m = *o
	...
	if o.Mode != nil {
		...
		case *ServiceSpec_Hook:
			...
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Hook, o.GetHook())
			m.Mode = &v
		case *ServiceSpec_Stateful:
			v := ServiceSpec_Stateful{
				Stateful: &StatefulService{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Stateful, o.GetStateful())
			m.Mode = &v
		}
	}
...
func (m *HookService) Copy() *HookService {
	if m == nil {
		return nil
	}
	o := &HookService{}
...
func (m *HookService) CopyFrom(src interface{}) {}
func (m *StatefulService) Copy() *StatefulService {
	if m == nil {
		return nil
	}
	o := &StatefulService{}
...
func (m *StatefulService) CopyFrom(src interface{}) {

	o := src.(*StatefulService)
	*m = *o
}
...
func (m *ServiceSpec_Hook) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Hook != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Hook.Size()))
...
func (m *ServiceSpec_Stateful) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Stateful != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Stateful.Size()))
		n11, err := m.Stateful.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *HookService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HookService) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *StatefulService) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StatefulService) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.InitHookID) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.InitHookID)))
		i += copy(dAtA[i:], m.InitHookID)
	}
	if len(m.PreScaleHookID) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.PreScaleHookID)))
		i += copy(dAtA[i:], m.PreScaleHookID)
	}
	if len(m.PostScaleHookID) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.PostScaleHookID)))
		i += copy(dAtA[i:], m.PostScaleHookID)
	}
	return i, nil
}
...
func (m *ContainerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Init != nil {
		nn26, err := m.Init.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn26
...
func (m *ServiceSpec_Hook) Size() (n int) {
	var l int
	_ = l
	if m.Hook != nil {
		l = m.Hook.Size()
...
func (m *ServiceSpec_Stateful) Size() (n int) {
	var l int
	_ = l
	if m.Stateful != nil {
		l = m.Stateful.Size()
...
func (m *HookService) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *StatefulService) Size() (n int) {
	var l int
	_ = l
	if m.Replicas != 0 {
		n += 1 + sovSpecs(uint64(m.Replicas))
	...
	l = len(m.PreScaleHookID)
	if l > 0 {
		n += 1 + l + sovSpecs(uint64(l))
	}
	l = len(m.PostScaleHookID)
	if l > 0 {
		n += 1 + l + sovSpecs(uint64(l))
	}
	return n
...
func (this *ServiceSpec_Hook) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceSpec_Hook{`,
		`Hook:` + strings.Replace(fmt.Sprintf("%v", this.Hook), "HookService", "HookService", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ServiceSpec_Stateful) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceSpec_Stateful{`,
		`Stateful:` + strings.Replace(fmt.Sprintf("%v", this.Stateful), "StatefulService", "StatefulService", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *HookService) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HookService{`,
		`}`,
	}, "")
	return s
}
func (this *StatefulService) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StatefulService{`,
		`Replicas:` + fmt.Sprintf("%v", this.Replicas) + `,`,
		`InitHookID:` + fmt.Sprintf("%v", this.InitHookID) + `,`,
		`PreScaleHookID:` + fmt.Sprintf("%v", this.PreScaleHookID) + `,`,
		`PostScaleHookID:` + fmt.Sprintf("%v", this.PostScaleHookID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *HookService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HookService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HookService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *StatefulService) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StatefulService: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatefulService: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitHookID", wireType)
			}
			...
			m.InitHookID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreScaleHookID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreScaleHookID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PostScaleHookID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PostScaleHookID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSpecs(dAtA[iNdEx:])
...
var fileDescriptorSpecs = []byte{
	...
	,
}
